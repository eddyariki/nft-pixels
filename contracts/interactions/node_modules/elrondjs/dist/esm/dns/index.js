...
import { stringToHex, TransactionOptionsBase, getNameShard } from '../lib';
...
export class Dns extends TransactionOptionsBase {
    ...
    resolve(name, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const c = yield Contract.at(this._config.shardContracts[shardId], mergedOptions);
            const ret = yield c.query('resolve', [stringToHex(name)]);
            if (ret.returnData.length) {
                return parseQueryResult(ret, { type: ContractQueryResultDataType.ADDRESS });
            }
            return '';
        });
    }
    ...
    register(name, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const shardId = getNameShard(name);
            // do it!
            const c = yield Contract.at(this._config.shardContracts[shardId], opts);
            return yield c.invoke('register', [stringToHex(name)], {
                gasLimit: 100000000
            });
        });
    }

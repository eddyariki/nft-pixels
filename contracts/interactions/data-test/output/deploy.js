...
var elrondjs_1 = require("elrondjs");
var fs_1 = require("fs");
...
var deploy = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                provider = new elrondjs_1.ProxyProvider(config_1.LOCAL_PROXY);
                return [4 /*yield*/, (provider === null || provider === void 0 ? void 0 : provider.getNetworkConfig())];
            case 1:
                config = _a.sent();
                console.log(config);
            ...
            case 2:
                ...
                dataTestWasm = fs_1.readFileSync("../../data-test/output/data-test.wasm");
            ...
            case 3:
                ...
                return [4 /*yield*/, elrondjs_1.Contract.at(contract.address, {
                        provider: provider
                    })];
            case 4:

 ...
 */
class Dns extends lib_1.TransactionOptionsBase {
    /**
     * Constructor.
     *
     ...
     */
    constructor(transactionOptions, dnsConfig) {
    ...
    resolve(name, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const shardId = lib_1.getNameShard(name);
            const c = yield contract_1.Contract.at(this._config.shardContracts[shardId], mergedOptions);
            const ret = yield c.query('resolve', [lib_1.stringToHex(name)]);
            if (ret.returnData.length) {
                return contract_1.parseQueryResult(ret, { type: common_1.ContractQueryResultDataType.ADDRESS });
            }
            return '';
        });
    }
    ...
    register(name, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const shardId = lib_1.getNameShard(name);
            // do it!
            const c = yield contract_1.Contract.at(this._config.shardContracts[shardId], opts);
            return yield c.invoke('register', [lib_1.stringToHex(name)], {
                gasLimit: 100000000
            });
        });
    }

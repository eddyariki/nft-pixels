                ...
                const _wait = () => {
                    setTimeout(() => {
                        this._provider.getTransaction(this._txHash)
                            ...
                            .catch(err => {
                            reject(new TransactionFailedError(`Error checking transaction ${this._txHash}: ${err.message}`));
                        });
 ...
 * @internal
 */
export class TransactionOptionsBase {
    /**
     * Constructor.
...
export class TransactionBuilder {
    ...
    toTransaction() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const tx = yield setDefaultGasPriceAndLimit({
 ...
 */
export const setDefaultGasPriceAndLimit = (tx, provider) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
export const verifyTransactionOptions = (options, ...fieldsToCheck) => {
    if (!options) {
 ...
 */
export const convertMapToDataArguments = (keyValueMap) => {
    return Object.keys(keyValueMap).reduce((m, v) => {
        m.push(stringToHex(v));
        m.push(stringToHex(keyValueMap[v] ? 'true' : 'false'));
        return m;
    }, []);
};
/**
 ...
 * @internal
 */
export const joinDataArguments = (...args) => {

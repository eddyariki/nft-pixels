...
exports.ProxyProvider = exports.parseRawTransaction = void 0;
 ...
 */
exports.parseRawTransaction = (tx) => {
    // status parsing: https://docs.elrond.com/querying-the-blockchain#transaction-status
    let status;
    switch (tx.status) {
        case 'success':
        case 'executed':
            status = common_1.TransactionStatus.SUCCESS;
            break;
        case 'invalid':
        case 'fail':
        case 'not-executed':
            status = common_1.TransactionStatus.FAILURE;
            break;
        default:
 ...
 */
class ProxyProvider extends lib_1.Api {
    /**
     * Constructor.
     *
    ...
    _sanitizeBalance(balance) {
        if (balance === '<nil>') {
            return new bigval_1.BigVal(0);
        }
        else {
            return new bigval_1.BigVal(balance);
        }
    }
    /**
     * Parse a reponse.
    ...
    waitForTransaction(txHash) {
        return __awaiter(this, void 0, void 0, function* () {
            return new lib_1.TransactionTracker(this, txHash).waitForCompletion();
        });
    }
    getTransaction(txHash) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return exports.parseRawTransaction(txData);
        });
    }
}
